...
class LinkedList
{
	...
	public Node clone(){
		...
		//return the head of clone list is not set, but in our map, head of original
		// list is mapped with first(head) element of clone list
		return map.get(this.head);
	}
}
class CloneWith_Next_Random
{
	// Main method.
	public static void main(String[] args){
		...
		Node cloneHead = list.clone();
		// Print the original and cloned linked list.
		System.out.println("Original linked list");
		list.print(list.head);
		System.out.println("\nCloned linked list");
		list.print(cloneHead);
	}
}
